...
# the 2D layout [1]. These ops are lowered into a Tensor Memory (TMEM) copy operation
# which moves the scale factors directly from SMEM to TMEM prior to consumption by the tcgen05.mma operation.
#
# For more detailed information, see
# 1. The scale factor layout discussion at https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mma-scale-factor-a-layout-1x.
# 2. The TMEM copy operation semantics at https://docs.nvidia.com/cuda/parallel-thread-execution/#tensorcore-5th-generation-instructions-tcgen05-cp
#
...
from triton._internal_testing import MXFP4Tensor, MXScaleTensor
